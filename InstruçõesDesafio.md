...
Seu desafio é criar esse aplicativo de calculadora de gorjetas e deixá-lo o mais próximo possível do design pedido.
...
Quer algum apoio no desafio? [Join our Slack community](https://www.frontendmentor.io/slack) e faça perguntas no **#help** channel.
...
Se você deseja que os arquivos de design (fornecemos as versões Sketch e Figma) inspecione o design com mais detalhes, você pode [inscrever-se como membro PRO](https://www.frontendmentor.io/pro).
...
Como mencionado acima, existem muitas maneiras de hospedar seu projeto gratuitamente. Nossas recomendações são:
